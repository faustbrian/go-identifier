...
nilaway:
	-$(GO) run go.uber.org/nilaway/cmd/nilaway@$(NILAWAY_VERSION) -include-pkgs='github.com/faustbrian/go-identifier/...' ./...
...
integration:
	$(GO) test -race ./... -run 'SQL|Database|PostgreSQL|Serialization'
